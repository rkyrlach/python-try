...
def plan(move, tier, min, dir):          # call with the distance you want to move in tachos
    ...
    if (move >= 2072): movesv = 200  # >30 foot subtract
    else:
      if (move >= 1726): movesv = 50   # >25 feet subtract
      else:
        if (move >= 1380): movesv = 50   # >20 feet subtract
        else:
          if (move >= 1034): movesv = 50   # >15 feet subtract
          else:
            if (move >= 688): movesv = 50    # >10 feet subtract
            else:
