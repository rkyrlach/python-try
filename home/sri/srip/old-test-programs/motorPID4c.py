...
def plan(move, tier, min, dir):          # call with the distance you want to move in tachos
    ...
    if (tier == 1):
      maxI = 5       # set tier 1
      if (move >= 3798): movesv = 140  # >55 feet subtract
      else:
        if (move >= 3453): movesv = 140  # >50 feet subtract
        else:
          if (move >= 3108): movesv = 140  # >45 feet subtract
          else:
            if (move >= 2762): movesv = 140  # >40 feet subtract
            else:
              if (move >= 2417): movesv = 140  # >35 feet subtract
              else:
                if (move >= 2072): movesv = 140  # >30 foot subtract
                else:
                  if (move >= 1726): movesv = 140  # >25 feet subtract
                  else:
                    if (move >= 1380): movesv = 115  # >20 feet subtract
                    else:
                      if (move >= 1034): movesv = 85   # >15 feet subtract
                      else:
                        if (move >= 688): movesv = 65    # >10 feet subtract
                        else:
                          if (move >= 346): movesv = 50    # >5 feet subtract
                          else: movesv = 0
    if (tier == 2):
      maxI = 13      # set tier 2
                ...
                if (move >= 2072): movesv = 100  # >30 foot subtract
                  ...
                  if (move >= 1726): movesv = 100  # >25 feet subtract
                    ...
                    if (move >= 1380): movesv = 100  # >20 feet subtract
                      ...
                      if (move >= 1034): movesv = 70   # >15 feet subtract
                      else:
                        if (move >= 688): movesv = 60    # >10 feet subtract
                        else:
                          if (move >= 346): movesv = 50    # >5 feet subtract
                          else: movesv = 0
    if (tier == 3):
      maxI = 21      # set tier 3
      if (move >= 3798): movesv = 550  # >55 feet subtract
      else:
        if (move >= 3453): movesv = 515  # >50 feet subtract
        else:
          if (move >= 3108): movesv = 490  # >45 feet subtract
          else:
            if (move >= 2762): movesv = 420  # >40 feet subtract
            else:
              if (move >= 2417): movesv = 300  # >35 feet subtract
              else:
                if (move >= 2072): movesv = 210  # >30 foot subtract
                else:
                  if (move >= 1726): movesv = 140  # >25 feet subtract
                  else:
                    if (move >= 1380): movesv = 115  # >20 feet subtract
